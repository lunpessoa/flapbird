...
SCREEN_WIDTH = 400
SCREEN_HEIGHT = 800 #Variaveis constantes em caixa alta
SPEED = 10
GRAVITY = 1
GAME_SPEED = 10
...
class Bird(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load("sprites/bluebird-midflap.png").convert_alpha()
...
for i in range(2):
    pipe = get_random_pipes(SCREEN_WIDTH * i + 800)
    pipe_group.add(pipe[0])
    pipe_group.add(pipe[1])
